...
{
    //PersonalContactsController scaffolded item using HarrisDbContext Data and PersonalContact Model.
    public class PersonalContactsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PersonalContactID,PersonalContactFName,PersonalContactLName,PersonalContactEmail,PersonalTel,PersonalContactAddr1,PersonalContactAddr2,PersonalContactCity,PersonalContactPostcode")] PersonalContact personalContact)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PersonalContactID,PersonalContactFName,PersonalContactLName,PersonalContactEmail,PersonalTel,PersonalContactAddr1,PersonalContactAddr2,PersonalContactCity,PersonalContactPostcode")] PersonalContact personalContact)
        {
