...
namespace Harris.net.Controllers
{
    ...
    public class BusinessContactsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("BusinessContactID,BusinessContactFName,BusinessContactLName,BusinessContactEmail,BusinessTel,BusinessContactAddr1,BusinessContactAddr2,BusinessContactCity,BusinessContactPostcode")] BusinessContact businessContact)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BusinessContactID,BusinessContactFName,BusinessContactLName,BusinessContactEmail,BusinessTel,BusinessContactAddr1,BusinessContactAddr2,BusinessContactCity,BusinessContactPostcode")] BusinessContact businessContact)
        {
